...
Tags: `docker`, `kvm`, `devpod`, `brave`, `chrome`, `vscode`, `codium`, `git`, `gh`, `btop`, `appimage`, `ai`, `claude`, `opencode`, `hermes`, `herdr`, `graphify`, `tailscale`, `age`, `sops`, plus groups `base`, `browsers`, `editors`, `network`, `secrets`.
